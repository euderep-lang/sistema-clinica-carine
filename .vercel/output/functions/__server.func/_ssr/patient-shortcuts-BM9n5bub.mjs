...
import { U as User, u as Stethoscope, j as CalendarCheck, aL as DollarSign, h as Calendar, _ as MessageCircle } from "../_libs/lucide-react.mjs";
...
function PatientShortcuts({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("flex items-center gap-1.5", className), children: [
    shortcuts.map(
      (s) => isAction(s) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          title: s.label,
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(s.icon, { className: "size-4", strokeWidth: 2.25 })
        },
        s.key
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "size-4", strokeWidth: 2.25 })
      }
    )
  ] });
}
