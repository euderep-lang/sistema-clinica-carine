...
import { t as todayISO, s as supabase, T as fmtDateLong, Q as parseDateOnly, R as fmtMonthYear, S as formatYMD, e as addMonthsISO } from "./index.mjs";
import { L as Link } from "../_libs/tanstack__react-router.mjs";
import { u as useServerFn } from "./createSsrRpc-fdWaaOKT.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { u as useAuth, G as resolveAppointmentTypes, H as APPOINTMENT_TYPE_OPTIONS, D as DashboardShell, B as Button, q as Badge, C as Card, b as CardHeader, e as CardTitle, f as CardContent, J as Table, M as TableHeader, N as TableRow, O as TableHead, Q as TableBody, U as TableCell, F as APPOINTMENT_TYPE_LABEL, V as APPOINTMENT_STATUS_LABEL, S as Select, l as SelectTrigger, m as SelectValue, n as SelectContent, o as SelectItem, s as Dialog, t as DialogContent, w as DialogHeader, x as DialogTitle, L as Label, I as Input, T as Textarea, y as DialogFooter, E as cn, r as Checkbox } from "./router-DcWaovdP.mjs";
import { A as AgendaContactActions } from "./agenda-contact-actions-BLP39QcP.mjs";
import { t as timeToMinutes, f as formatTimeInterval, a as addOneHour, b as buildHourSlots, c as currentTimePercent, d as formatAgendaDate, A as AGENDA_DAY_START, e as AGENDA_SLOT_MINUTES, g as AGENDA_DAY_END } from "./agenda-utils-DAU-4XZp.mjs";
...
import { t as triggerAppointmentFollowUp, a as triggerAppointmentStatusFollowUp } from "./whatsapp-crm.functions-Dmtynik5.mjs";
import "../_libs/seroval.mjs";
import "../_libs/jspdf.mjs";
import { O as LayoutGrid, Q as Building2, V as List, P as Plus, Y as CalendarDays, S as Search, Z as CalendarClock, b as Printer, x as ChevronLeft, w as ChevronRight } from "../_libs/lucide-react.mjs";
import "node:crypto";
...
function AgendaRescheduleButton({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Button,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarClock, { className: size === "icon" ? "size-3.5" : "size-4" }),
        size === "sm" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Reagendar" })
      ]
    }
  );
}
function AgendaFiltersPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full shrink-0 flex-col gap-4 lg:w-72", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "h-auto flex-col gap-1 py-3", onClick: onNewAppointment, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "size-5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: "Novo" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "h-auto flex-col gap-1 py-3", onClick: onPrint, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "size-5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: "Imprimir" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border bg-card p-3 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Data" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "date", value: date, onChange: (e) => onDateChange(e.target.value) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border p-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "ghost", size: "icon", className: "size-7", onClick: () => shiftMonth(-1), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "size-4" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium capitalize", children: monthLabel }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "ghost", size: "icon", className: "size-7", onClick: () => shiftMonth(1), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "size-4" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 gap-0.5 text-center text-[10px] text-muted-foreground", children: ["D", "S", "T", "Q", "Q", "S", "S"].map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: d }, `${d}-${i}`)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 grid grid-cols-7 gap-0.5", children: [
          Array.from({ length: startWeekday }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}, `empty-${i}`)),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border bg-card p-3 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Profissional" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: filterProfessional, onValueChange: onFilterProfessionalChange, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "Todos" }),
            professionals.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: p.id, children: p.full_name }, p.id))
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Consultório" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: filterRoom, onValueChange: onFilterRoomChange, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "Todos" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "none", children: "Sem consultório" }),
            rooms.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: r.id, children: r.name }, r.id))
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Das" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "time", value: timeFrom, onChange: (e) => onTimeFromChange(e.target.value) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Até" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "time", value: timeTo, onChange: (e) => onTimeToChange(e.target.value) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Checkbox, { checked: showCancelled, onCheckedChange: (v) => onShowCancelledChange(v === true) }),
        "Ver desmarcados"
      ] }),
...
function AgendaRescheduleDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Reagendar consulta" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border bg-muted/30 p-3 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: appointment.patients?.full_name ?? "Paciente" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex flex-wrap gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs", children: APPOINTMENT_TYPE_LABEL[appointment.type ?? ""] ?? appointment.type ?? "Consulta" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs", children: STATUS_LABEL$2[appointment.status] ?? appointment.status })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: form.room_id, onValueChange: (value) => setForm((f) => ({ ...f, room_id: value })), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "none", children: "Sem consultório" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: save, disabled: saving, children: saving ? "Salvando..." : "Salvar alterações" })
    ] })
  ] }) });
}
...
function AgendaRoomsOverview({
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-[520px] items-center justify-center rounded-lg border bg-card text-muted-foreground", children: "Carregando agenda..." });
  }
  if (rooms.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-[320px] flex-col items-center justify-center gap-2 rounded-lg border bg-card p-8 text-center text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground", children: "Nenhum consultório cadastrado" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "Cadastre consultórios em Configurações → Consultórios para usar esta visão." })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-[520px] flex-col overflow-hidden rounded-lg border bg-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b bg-primary px-4 py-2.5 text-primary-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-semibold capitalize", children: [
        "Visão geral · ",
        formatAgendaDate(date)
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-x-3 gap-y-1 text-sm font-normal opacity-90", children: [
        ...
        columns.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded bg-primary-foreground/15 px-2 py-0.5 text-xs", children: "Arraste horizontalmente para ver todos os consultórios" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-0 flex-1 overflow-x-auto overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "inline-grid w-max min-w-full",
        style: { gridTemplateColumns: `4rem repeat(${columns.length}, 12rem)` },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky left-0 z-20 border-b border-r bg-muted/40 shadow-[4px_0_8px_-4px_rgba(0,0,0,0.12)]" }),
          columns.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "line-clamp-2", children: col.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mt-0.5 block text-xs font-normal text-muted-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky left-0 z-10 border-r bg-muted/30 shadow-[4px_0_8px_-4px_rgba(0,0,0,0.12)]", children: slots.map((slot) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          columns.map((col) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-w-[12rem] border-r last:border-r-0", children: [
              ...
              colRows.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center p-2 text-center text-xs text-muted-foreground", children: "Livre" }),
              colRows.map((row) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-semibold text-primary", children: formatTimeInterval(row.start_time, row.end_time) }),
                      row.patient_id ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Link,
                        {
                      ...
                      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", children: "—" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "truncate text-[10px] text-muted-foreground", children: row.profiles?.full_name ?? "—" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex items-center justify-between gap-1", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "h-4 px-1 text-[9px]", children: STATUS_LABEL$1[row.status] ?? row.status }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5", onClick: (e) => e.stopPropagation(), children: [
                          onReschedule && /* @__PURE__ */ jsxRuntimeExports.jsx(AgendaRescheduleButton, { row, onReschedule }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "truncate text-[9px] text-muted-foreground", children: APPOINTMENT_TYPE_LABEL[row.type ?? ""] ?? row.type ?? "Consulta" })
                    ]
                  },
                  row.id
                );
...
function AgendaTimelineView({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-[520px] flex-col overflow-hidden rounded-lg border bg-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2 border-b bg-primary px-4 py-2.5 text-primary-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-semibold capitalize", children: [
        activeProfessionalId === "all" ? "Todos os profissionais" : activePro?.full_name ?? "Profissional",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mx-2 opacity-60", children: "·" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-normal", children: formatAgendaDate(date) })
      ] }),
      headerExtra
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1 border-b bg-muted/30 px-3 py-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      professionals.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-1 items-center justify-center py-16 text-muted-foreground", children: "Carregando agenda..." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-1 overflow-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-w-0 flex-1", children: [
        ...
        rows.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center text-sm text-muted-foreground", children: "Nenhum agendamento neste período" }),
        rows.map((row) => {
          const startMin = timeToMinutes(row.start_time.slice(0, 5)) - AGENDA_DAY_START * 60;
          const endMin = timeToMinutes((row.end_time ?? row.start_time).slice(0, 5)) - AGENDA_DAY_START * 60;
          const top = Math.max(0, startMin / totalMinutes * 100);
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex shrink-0 items-center gap-0.5", onClick: (e) => e.stopPropagation(), children: [
                    onReschedule && /* @__PURE__ */ jsxRuntimeExports.jsx(AgendaRescheduleButton, { row, onReschedule }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      AgendaContactActions,
                      {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex flex-wrap gap-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "h-5 px-1.5 text-[10px]", children: STATUS_LABEL[row.status] ?? row.status })
                ] })
              ]
            },
            row.id
...
function AgendaPage() {
  ...
  const [timeFrom, setTimeFrom] = reactExports.useState("08:00");
  const [timeTo, setTimeTo] = reactExports.useState("22:00");
  const [filterProfessional, setFilterProfessional] = reactExports.useState("all");
  const [filterRoom, setFilterRoom] = reactExports.useState("all");
  const [showCancelled, setShowCancelled] = reactExports.useState(false);
  ...
  const [rescheduleRow, setRescheduleRow] = reactExports.useState(null);
  const [saving, setSaving] = reactExports.useState(false);
  ...
  const filteredRowsForRooms = reactExports.useMemo(() => {
    const fromMin = timeToMinutes(timeFrom);
    const toMin = timeToMinutes(timeTo);
    return rows.filter((row) => {
      if (!showCancelled && row.status === "cancelled") return false;
  ...
  const filtersPanel = /* @__PURE__ */ jsxRuntimeExports.jsx(AgendaFiltersPanel, { date, onDateChange: setDate, timeFrom, timeTo, onTimeFromChange: setTimeFrom, onTimeToChange: setTimeTo, filterProfessional, onFilterProfessionalChange: setFilterProfessional, filterRoom, onFilterRoomChange: setFilterRoom, showCancelled, onShowCancelledChange: setShowCancelled, professionals, rooms, onNewAppointment: openNew, onPrint: handlePrint });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DashboardShell, { title: "Agenda", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 print:space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between print:hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold", children: "Agenda" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Visualize em grade ou lista, com filtros por data, horário, profissional e consultório." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tabs, { value: viewMode, onValueChange: (v) => setViewMode(v), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "timeline", className: "gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutGrid, { className: "size-4" }),
              " Grade"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "rooms", className: "gap-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: openNew, className: "print:hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "mr-2 size-4" }),
            "Novo agendamento"
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 sm:grid-cols-4 print:hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryCard, { label: "Total", value: totals.all }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryCard, { label: "Pendentes", value: totals.pending }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryCard, { label: "Confirmados", value: totals.confirmed }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryCard, { label: "Concluídos", value: totals.completed })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 lg:flex-row-reverse", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "print:hidden", children: filtersPanel }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-0 flex-1", children: viewMode === "timeline" ? /* @__PURE__ */ jsxRuntimeExports.jsx(AgendaTimelineView, { date, rows: filteredRows, loading, activeProfessionalId: filterProfessional, onProfessionalChange: setFilterProfessional, professionals, headerExtra: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "bg-primary-foreground/15 text-primary-foreground", children: [
          filteredRows.length,
          " horários"
        ] }), onReschedule: openReschedule }) : viewMode === "rooms" ? /* @__PURE__ */ jsxRuntimeExports.jsx(AgendaRoomsOverview, { date, rows: filteredRowsForRooms, rooms, loading, onReschedule: openReschedule }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2 text-base capitalize", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0 overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Consultório" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { colSpan: 8, className: "py-10 text-center text-muted-foreground", children: "Carregando agenda..." }) }) : filteredRows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { colSpan: 8, className: "py-10 text-center text-muted-foreground", children: "Nenhum agendamento para os filtros selecionados." }) }) : filteredRows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "whitespace-nowrap font-medium", children: formatTimeInterval(row.start_time, row.end_time) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { children: [
                row.patient_id ? /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/reception/pacientes/$id", params: {
                  id: row.patient_id
                }, className: "font-medium hover:underline", children: row.patients?.full_name ?? "Paciente" }) : "—",
                row.patients?.phone && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: row.patients.phone })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AgendaContactActions, { phone: row.patients?.phone, patientId: row.patient_id, patientName: row.patients?.full_name, size: "icon" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: row.profiles?.full_name ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: row.rooms?.name ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: APPOINTMENT_TYPE_LABEL[row.type ?? ""] ?? row.type ?? row.specialty ?? "Consulta" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: STATUS_CLASS[row.status] ?? STATUS_CLASS.scheduled, children: APPOINTMENT_STATUS_LABEL[row.status] ?? row.status }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AgendaRescheduleButton, { row, onReschedule: openReschedule, size: "sm" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: row.status, onValueChange: (value) => updateStatus(row.id, value), children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-36", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: Object.entries(APPOINTMENT_STATUS_LABEL).map(([value, label]) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value, children: label }, value)) })
                ] })
              ] }) })
            ] }, row.id)) })
          ] }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (value) => {
      setOpen(value);
      if (!value) {
        setPatientSearch("");
        setPatientPickerOpen(false);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 space-y-2", ref: patientPickerRef, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: patientSearch, onChange: (e) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: form.professional_id, onValueChange: (value) => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: professionals.map((professional) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: professional.id, children: professional.full_name }, professional.id)) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Consultório" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: form.room_id, onValueChange: (value) => setForm((f) => ({
            ...f,
            room_id: value
          })), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Data" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "date", value: form.date, onChange: (e) => setForm((f) => ({
            ...f,
            date: e.target.value
          })) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Início" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "time", value: form.start_time, onChange: (e) => setForm((f) => ({
              ...f,
              start_time: e.target.value,
              end_time: addOneHour(e.target.value)
            })) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Fim" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "time", value: form.end_time, onChange: (e) => setForm((f) => ({
              ...f,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: form.type, onValueChange: (value) => setForm((f) => ({
            ...f,
            type: value
          })), disabled: !form.professional_id, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: form.professional_id ? "Selecione" : "Escolha o profissional" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: form.specialty, onChange: (e) => setForm((f) => ({
            ...f,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { value: form.notes, onChange: (e) => setForm((f) => ({
            ...f,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AgendaRescheduleDialog, { open: rescheduleOpen, onOpenChange: setRescheduleOpen, appointment: rescheduleRow, rooms, onSaved: handleRescheduled })
  ] });
}
