...
export {
  deleteWaQuickReply as A,
  getWaPatientContext as B,
  getWaTagRules as C,
  upsertWaTagRule as D,
  deleteWaTagRule as E,
  getWaTasks as F,
  createWaTask as G,
  completeWaTask as H,
  ...
  assignWaConversation as b,
  closeWaConversation as c,
  assignWaQueueToReception as d,
  ensureWaPipeline as e,
  toggleWaConversationTag as f,
  getWaPipelineBoard as g,
  markWaObjection as h,
  syncWaChatsFromZApi as i,
  createWaDeal as j,
  fetchWaContactPhoto as k,
  linkWaPatient as l,
  moveWaDealStage as m,
  getWhatsAppConnection as n,
  searchWaMessagesGlobal as o,
  processWaFollowUps as p,
  getMetaWaTemplates as q,
  reopenWaConversation as r,
  searchWaMessages as s,
  triggerAppointmentFollowUp as t,
  sendWaBroadcast as u,
  getCrmMetrics as v,
  getWaQuickReplies as w,
  seedWaQuickReplies as x,
  seedFollowUpQuickReplies as y,
  upsertWaQuickReply as z
};
