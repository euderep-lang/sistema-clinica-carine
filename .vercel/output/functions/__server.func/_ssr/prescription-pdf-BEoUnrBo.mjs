...
import { r as resolvePdfPadding, p as pdfContentW, a as paintLetterhead } from "./letterhead-pdf-8X66Bk4t.mjs";
import { a as ageFromBirthDate, m as maskCPF } from "./patient-utils-YNqCHR6o.mjs";
...
async function generatePrescriptionPDF(rx) {
  ...
  if (rx.type === "simples") {
    const doc2 = new jspdf_node_minExports.jsPDF({ unit: "mm", format: "a4", orientation: "portrait" });
