-- Alinha add_sale_items ao finish_consultation: insumos por venda (session_package_inventory_items)
-- e baixa de estoque apenas na utilização da sessão, não na venda.
