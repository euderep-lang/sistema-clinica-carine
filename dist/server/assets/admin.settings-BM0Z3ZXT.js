...
import { Loader2, Upload, Trash2, Check, Plus, Pencil, X, Copy, RefreshCw, Mail, Phone, MessageSquare, FileSignature, CreditCard, Calendar, Cloud, Receipt, Building2, Palette, DoorOpen, Stethoscope, Users, Plug } from "lucide-react";
import { u as useAuth, aa as DEFAULT_HOURS, ab as getTenantSetting, C as Card, a as CardHeader, b as CardTitle, c as CardContent, L as Label, I as Input, ac as maskCNPJ, ad as maskPhone, ae as maskCEP, af as DAY_LABELS, Y as Switch, B as Button, ag as fetchViaCEP, ah as setTenantSetting, ai as FONT_OPTIONS, aj as loadGoogleFont, m as Badge, ak as applyThemeColors, al as applyFont, w as cn, am as buttonVariants, o as Dialog, p as DialogContent, q as DialogHeader, r as DialogTitle, T as Textarea, s as DialogFooter, an as resolveSpecialties, ao as isLegacySpecialtyList, E as Table, F as TableHeader, G as TableRow, H as TableHead, J as TableBody, M as TableCell, A as Avatar, h as AvatarFallback, a7 as DialogDescription, S as Select, i as SelectTrigger, j as SelectValue, k as SelectContent, l as SelectItem, O as DEFAULT_APPOINTMENT_TYPES, v as renderTemplate, ap as TEMPLATE_VARS, aq as SAMPLE_VARS, ar as TooltipProvider, as as Tooltip, at as TooltipTrigger, au as TooltipContent, D as DashboardShell } from "./router-CL5eFCiw.js";
import { s as supabase } from "./client-CUE-_UGz.js";
import { toast } from "sonner";
import * as AlertDialogPrimitive from "@radix-ui/react-alert-dialog";
import { c as createSsrRpc, u as useServerFn } from "./createSsrRpc-CFVnU8vV.js";
import { a as createServerFn } from "./server-DiyCfIqC.js";
import { r as requireSupabaseAuth } from "./auth-middleware-DmmNMkxH.js";
import { m as maskCPF, c as isValidCPF } from "./patient-utils-YNqCHR6o.js";
import { S as SectionServicos } from "./section-servicos-DyCaZ1vR.js";
