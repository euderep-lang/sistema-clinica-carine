...
import { av as Route, D as DashboardShell, C as Card, c as CardContent, m as Badge, B as Button, a as CardHeader, b as CardTitle, E as Table, F as TableHeader, G as TableRow, H as TableHead, J as TableBody, M as TableCell, x as APPOINTMENT_TYPE_LABEL, N as APPOINTMENT_STATUS_LABEL, S as Select, i as SelectTrigger, j as SelectValue, k as SelectContent, l as SelectItem, I as Input, aw as Sheet, ax as SheetContent, ay as SheetHeader, az as SheetTitle, aA as pushRecentPatient } from "./router-CL5eFCiw.js";
...
import { P as PatientFormDialog } from "./patient-form-dialog-Bo_gpkpi.js";
  ...
  return /* @__PURE__ */ jsxs(DashboardShell, { title: patient.full_name, children: [
      ...
      /* @__PURE__ */ jsxs(Tabs, { value: tab, onValueChange: (value) => navigate({
          ...
          /* @__PURE__ */ jsx(CardContent, { className: "p-0", children: (() => {
            ...
            return /* @__PURE__ */ jsxs(Table, { children: [
              ...
              /* @__PURE__ */ jsx(TableBody, { children: filtered.map((r) => /* @__PURE__ */ jsxs(TableRow, { children: [
                /* @__PURE__ */ jsx(TableCell, { children: new Date(r.date).toLocaleDateString("pt-BR") }),
        ...
        /* @__PURE__ */ jsx(TabsContent, { value: "financeiro", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
          /* @__PURE__ */ jsxs(Card, { children: [
            ...
            /* @__PURE__ */ jsx(CardContent, { className: "text-2xl font-bold", children: "R$ 0,00" })
          ] }),
          /* @__PURE__ */ jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsx(Sheet, { open: !!recordOpen, onOpenChange: (v) => !v && setRecordOpen(null), children: /* @__PURE__ */ jsxs(SheetContent, { className: "overflow-y-auto sm:max-w-lg", children: [
      /* @__PURE__ */ jsx(SheetHeader, { children: /* @__PURE__ */ jsxs(SheetTitle, { children: [
        "Prontuário · ",
        recordOpen && new Date(recordOpen.date).toLocaleDateString("pt-BR")
      ] }) }),
