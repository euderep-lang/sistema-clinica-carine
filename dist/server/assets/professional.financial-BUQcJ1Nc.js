...
import { E as cn, D as DashboardShell } from "./router-DKQJQoSP.js";
...
const FinancialCobrancasTab = lazy(() => import("./financial-cobrancas-tab-Dw6nqAW4.js").then((m) => ({
  default: m.FinancialCobrancasTab
})));
const FinancialCaixaTab = lazy(() => import("./financial-caixa-tab-CqypyxEP.js").then((m) => ({
  default: m.FinancialCaixaTab
})));
const FinancialDespesasTab = lazy(() => import("./financial-despesas-tab-B1qOMvNK.js").then((m) => ({
  default: m.FinancialDespesasTab
})));
const ProfessionalFinancialReports = lazy(() => import("./professional-financial-reports-Dkry0NIc.js").then((m) => ({
