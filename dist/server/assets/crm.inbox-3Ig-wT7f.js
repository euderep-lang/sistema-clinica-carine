...
import { c as compressForUpload, R as ResizablePanelGroup, a as ResizablePanel, b as ResizableHandle } from "./resizable-DYucfpuq.js";
import { P as PageHeader } from "./page-header-BNsdM97h.js";
import { S as ScrollArea } from "./scroll-area-CZMombI1.js";
...
const crmPanelShell = "flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden rounded-2xl border border-border/60 bg-card shadow-[0_1px_3px_rgba(0,0,0,0.06)]";
const LAYOUT_KEY = "crm-inbox-panel-layout-v2";
const LEGACY_LAYOUT_KEY = "crm-inbox-panel-layout";
...
function sanitizeLayout(input) {
  ...
  const contacts = clamp(Number(input.contacts) || DEFAULT_LAYOUT.contacts, 22, 36);
  const tools = clamp(Number(input.tools) || DEFAULT_LAYOUT.tools, 22, 36);
  let chat = clamp(Number(input.chat) || DEFAULT_LAYOUT.chat, 32, 52);
  const sum = contacts + chat + tools;
  if (!Number.isFinite(sum) || sum < 95 || sum > 105) {
    return DEFAULT_LAYOUT;
  }
  chat = clamp(100 - contacts - tools, 32, 52);
  const toolsFinal = 100 - contacts - chat;
  if (toolsFinal < 22) return DEFAULT_LAYOUT;
  return { contacts, chat, tools: toolsFinal };
}
function readLayout() {
...
function CrmInboxLayout({
  ...
  if (!isLg) {
    return /* @__PURE__ */ jsxs("div", { className: cn("flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden", className), children: [
      /* @__PURE__ */ jsx("div", { className: cn("flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden", mobileView !== "list" && "hidden"), children: contacts }),
      /* @__PURE__ */ jsx(
        "div",
        {
          className: cn(
            "flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden",
            (mobileView === "list" || mobileView === "details") && "hidden"
          ),
          children: chat
        }
      ),
      /* @__PURE__ */ jsx("div", { className: cn("flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden", mobileView !== "details" && "hidden"), children: tools })
    ] });
  }
  return /* @__PURE__ */ jsxs(
    ResizablePanelGroup,
    {
      ...
      onLayoutChanged: (next) => {
        const safe = sanitizeLayout(next);
        try {
          localStorage.setItem(LAYOUT_KEY, JSON.stringify(safe));
        } catch {
        }
      },
      children: [
        /* @__PURE__ */ jsx(ResizablePanel, { id: "contacts", minSize: 22, maxSize: 36, className: "min-h-0 min-w-0", children: /* @__PURE__ */ jsx("div", { className: "flex h-full min-h-0 min-w-0 flex-col overflow-hidden", children: contacts }) }),
        /* @__PURE__ */ jsx(ResizableHandle, { className: "mx-px w-1.5 shrink-0 bg-border/80 transition-colors hover:bg-emerald-500/45" }),
        /* @__PURE__ */ jsx(ResizablePanel, { id: "chat", minSize: 32, className: "min-h-0 min-w-0", children: /* @__PURE__ */ jsx("div", { className: "flex h-full min-h-0 min-w-0 flex-col overflow-hidden", children: chat }) }),
        /* @__PURE__ */ jsx(ResizableHandle, { className: "mx-px w-1.5 shrink-0 bg-border/80 transition-colors hover:bg-emerald-500/45" }),
        /* @__PURE__ */ jsx(ResizablePanel, { id: "tools", minSize: 22, maxSize: 36, className: "min-h-0 min-w-0", children: /* @__PURE__ */ jsx("div", { className: "flex h-full min-h-0 min-w-0 flex-col overflow-hidden", children: tools }) })
      ]
    }
  );
}
...
function CrmInboxPage() {
  ...
  return /* @__PURE__ */ jsxs(DashboardShell, { title: "CRM WhatsApp", fullWidth: true, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex h-[calc(100dvh-4rem)] min-w-0 flex-col gap-3 overflow-x-hidden lg:h-[calc(100dvh-7.5rem)]", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: cn(crmPanelShell, "flex min-h-0 min-w-0 flex-1 flex-col"), children: /* @__PURE__ */ jsx(
        CrmInboxLayout,
        {
          mobileView,
          className: "min-h-0 flex-1",
          contacts: /* @__PURE__ */ jsxs("aside", { className: "flex min-h-0 min-w-0 flex-col overflow-hidden border-border/60 bg-muted/20 lg:border-r", children: [
          ...
          chat: /* @__PURE__ */ jsx("main", { className: "flex min-h-0 min-w-0 flex-col overflow-hidden", children: !selected && !composeTarget ? /* @__PURE__ */ jsx("div", { className: cn("flex flex-1 flex-col items-center justify-center", crmChatBg), children: /* @__PURE__ */ jsxs("div", { className: "rounded-2xl bg-background/80 px-8 py-10 text-center shadow-sm backdrop-blur-sm", children: [
...
${t}` : t)
          ...
          tools: /* @__PURE__ */ jsx("aside", { className: cn(crmDetailAsideShell, "min-h-0 min-w-0"), children: /* @__PURE__ */ jsxs(Tabs, { value: detailTab, onValueChange: setDetailTab, className: crmDetailTabsRoot, children: [
