...
import { s as supabase, f as fmtDate, t as todayISO, g as getTenantSetting, af as formatClinicAddressLines, U as formatClinicAddress } from "../server.js";
...
import { z as randomUUID, s as Dialog, t as DialogContent, w as DialogHeader, x as DialogTitle, B as Button, y as DialogFooter, u as useAuth, aS as Route, D as DashboardShell, C as Card, f as CardContent, L as Label, g as Popover, h as PopoverTrigger, j as PopoverContent, $ as Command, a0 as CommandInput, a1 as CommandList, a2 as CommandEmpty, a3 as CommandGroup, a4 as CommandItem, I as Input, T as Textarea, S as Select, l as SelectTrigger, m as SelectValue, n as SelectContent, o as SelectItem, aT as PopoverAnchor, a7 as loadLetterheadForPdf } from "./router-DKQJQoSP.js";
...
import { i as initiateSafeIdSignatureAuth, e as getSafeIdSignatureAuthStatus, g as getDigitalCertificateStatus, f as signPrescriptionPdf } from "./digital-certificate.functions-B-YVITPa.js";
...
function SimplePreviewPanel({
  ...
  return /* @__PURE__ */ jsx(Card, { className: "overflow-hidden border-2 border-[#C5B358]/40", children: /* @__PURE__ */ jsxs(CardContent, { className: "relative min-h-[420px] space-y-4 bg-white p-6 text-black", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative space-y-1 text-[11px]", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-[10px] text-muted-foreground", children: [data.patient.cpf ? `CPF: ${maskCPF(data.patient.cpf)}` : null, age !== null ? `Idade: ${age} anos` : null, `Data: ${fmtDate(data.date)}`].filter(Boolean).join(" · ") })
    ] }),
