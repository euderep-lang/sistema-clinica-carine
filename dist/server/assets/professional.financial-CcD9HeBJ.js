...
import { E as cn, D as DashboardShell } from "./router-C3L3OxIm.js";
...
const FinancialCobrancasTab = lazy(() => import("./financial-cobrancas-tab-BssEwkNY.js").then((m) => ({
  default: m.FinancialCobrancasTab
})));
const FinancialCaixaTab = lazy(() => import("./financial-caixa-tab-EYmWklUl.js").then((m) => ({
  default: m.FinancialCaixaTab
})));
const FinancialDespesasTab = lazy(() => import("./financial-despesas-tab-BoxwWNOC.js").then((m) => ({
  default: m.FinancialDespesasTab
})));
const ProfessionalFinancialReports = lazy(() => import("./professional-financial-reports-BNePkp8K.js").then((m) => ({
