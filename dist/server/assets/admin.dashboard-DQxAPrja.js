...
import { u as useAuth, C as Card, c as CardContent, a as CardHeader, b as CardTitle, L as Label, I as Input, B as Button, m as Badge, T as Textarea, E as Table, F as TableHeader, G as TableRow, H as TableHead, J as TableBody, M as TableCell, W as fmt, D as DashboardShell } from "./router-uS_mSfDy.js";
...
import { T as TableSkeleton } from "./feedback-states-C9F-zuXp.js";
import { toast } from "sonner";
import { s as supabase } from "./client-CUE-_UGz.js";
import { c as currentYearMonth, p as periodFromYearMonth, b as buildProfessionalProduction, e as effectiveCommissionPct, a as commissionValue, t as todayISO } from "./commission-B9zJlqRy.js";
  ...
  const load = useCallback(async () => {
    ...
    try {
      const [{ data: profs }, { data: bills }, { data: appts }, { data: existing }] = await Promise.all([
        ...
        supabase.from("bills_receivable").select("professional_id, amount, paid_amount, status, due_date, paid_date").or(
        ...
        children: [
          ...
          loading ? /* @__PURE__ */ jsx(TableSkeleton, {}) : professionals.length === 0 ? /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardContent, { className: "py-8 text-center text-muted-foreground", children: "Nenhum profissional ativo com movimentação no período." }) }) : /* @__PURE__ */ jsxs("div", { className: "grid gap-4 lg:grid-cols-[1fr_320px]", children: [
            /* @__PURE__ */ jsxs(Card, { children: [
              ...
              /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxs(BarChart, { data: professionals, children: [
