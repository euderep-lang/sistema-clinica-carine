...
import { _ as fmtMessageTime, P as fmtDateTimeFromDate, f as fmtDate, J as renderTemplate, N as fmtDateTime, s as supabase, $ as dedupeConversationsByPhone, k as phonesMatch, a0 as fmtRelativeTime } from "../server.js";
import { Link, getRouteApi } from "@tanstack/react-router";
import { u as useServerFn, c as createSsrRpc } from "./createSsrRpc-BRag-Yhq.js";
import { UserRound, Reply, Loader2, FileText, ExternalLink, Square, Mic, Inbox, UserX, MessageCircle, Timer, Calendar, Search, Megaphone, Check, Zap, Trash2, BarChart3, RefreshCw, Bell, ArrowLeft, Info, ArrowRightLeft, Plus, MessageSquare, X, Paperclip, Video, FileAudio, Send, Tag, StickyNote, ClipboardList } from "lucide-react";
import { toast } from "sonner";
import { A as Avatar, ak as AvatarImage, E as cn, k as AvatarFallback, al as isDirectMediaUrl, am as waMessageStatusTicks, B as Button, u as useAuth, an as appointmentStatusLabel, ao as QUICK_REPLY_CATEGORY_LABELS, s as Dialog, ap as DialogTrigger, t as DialogContent, w as DialogHeader, x as DialogTitle, I as Input, c as conversationDisplayName, q as Badge, aq as CHANNEL_LABEL, L as Label, S as Select, l as SelectTrigger, m as SelectValue, n as SelectContent, o as SelectItem, T as Textarea, y as DialogFooter, ar as TASK_TYPE_LABEL, as as TASK_PRIORITY_LABEL, at as WA_CLOSE_REASONS, au as TAG_COLORS, av as getWaNotificationPermission, aw as conversationPrimaryTagColor, D as DashboardShell, C as Card, ax as isSecureNotificationContext, ay as CHANNEL_BADGE_CLASS, az as formatPhoneBR, aA as WA_STATUS_LABEL, aB as WA_OBJECTION_LABELS, aC as requestWaNotificationPermission, aD as fileToBase64, aE as waInboxFocus } from "./router-C3L3OxIm.js";
import { f as fetchWaContactPhoto, b as getWhatsAppConnection, c as getCrmMetrics, d as getWaPatientContext, h as getWaQuickReplies, s as seedWaQuickReplies, i as seedFollowUpQuickReplies, j as searchWaMessagesGlobal, k as getMetaWaTemplates, l as sendWaBroadcast, n as getWaTasks, o as createWaTask, p as completeWaTask, q as getWaTagRules, u as upsertWaTagRule, r as deleteWaTagRule, v as closeWaConversation, w as reopenWaConversation, x as linkWaPatient, y as assignWaConversation, z as assignWaQueueToReception, A as toggleWaConversationTag, B as markWaObjection, C as processWaFollowUps, D as searchWaMessages, E as syncWaChatsFromZApi, F as createWaDeal } from "./whatsapp-crm.functions-BEmBnR-J.js";
...
function CrmQuickReplies({ onSelect, disabled, templateVars }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mb-2 space-y-1.5", children: [
    categories.length > 2 ? /* @__PURE__ */ jsx("div", { className: "flex gap-1 overflow-x-auto pb-0.5 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden", children: categories.map((c) => /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
        className: cn(
...
const crmDetailAsideShell = "flex w-full shrink-0 flex-col border-border/60 bg-[#f7f9f8] dark:bg-zinc-950 lg:w-[min(100%,340px)] lg:border-l";
const crmDetailTabsRoot = "flex min-h-0 flex-1 flex-col lg:flex-row";
const crmDetailTabList = "mx-0 flex h-auto w-full shrink-0 gap-1 overflow-x-auto border-b border-border/50 bg-background/80 p-2 [-ms-overflow-style:none] [scrollbar-width:none] lg:w-[4.75rem] lg:flex-col lg:overflow-visible lg:border-b-0 lg:border-r lg:p-1.5 [&::-webkit-scrollbar]:hidden";
const crmDetailContentWrap = "flex min-h-0 min-w-0 flex-1 flex-col";
const crmDetailHeader = "shrink-0 border-b border-border/40 bg-background/90 px-4 py-3 backdrop-blur-sm";
const crmDetailScroll = "min-h-0 flex-1 overflow-y-auto px-4 py-4";
...
const crmComposerBar = "border-t border-border/50 bg-[#f0f2f5]/95 px-3 py-2.5 backdrop-blur-sm dark:bg-background/95 pb-[max(0.625rem,env(safe-area-inset-bottom))]";
const crmPanelShell = "flex min-h-0 flex-1 overflow-hidden rounded-2xl border border-border/60 bg-card shadow-[0_1px_3px_rgba(0,0,0,0.06)]";
...
function CrmInboxPage() {
  ...
  const loadConversations = useCallback(async () => {
    ...
    setConversations(dedupeConversationsByPhone(convRes.data ?? []));
    const pending = {};
    ...
    void (async () => {
      ...
      if (byPhone) {
        ...
        if (!byPhone.patient_id) {
          void linkPatientFn({ data: { conversationId: byPhone.id, patientId: patientFromUrl } }).then(() => loadConversationsRef.current()).catch(() => {
          });
        }
        return;
      }
  ...
  useEffect(() => {
    ...
    const poll = window.setInterval(() => void loadConversationsRef.current(), 2e4);
    return () => {
  ...
  return /* @__PURE__ */ jsxs(DashboardShell, { title: "CRM WhatsApp", fullWidth: true, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex h-[calc(100dvh-4rem)] flex-col gap-3 lg:h-[calc(100dvh-7.5rem)]", children: [
      /* @__PURE__ */ jsxs("div", { className: "hidden shrink-0 items-center justify-between gap-4 lg:flex", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: cn(crmPanelShell, "min-h-0 flex-1"), children: [
        /* @__PURE__ */ jsxs(
          "aside",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-2.5 border-b border-border/50 p-3", children: [
        ...
        /* @__PURE__ */ jsx(
          "main",
          {
            ...
            children: !selected && !composeTarget ? /* @__PURE__ */ jsx("div", { className: cn("flex flex-1 flex-col items-center justify-center", crmChatBg), children: /* @__PURE__ */ jsxs("div", { className: "rounded-2xl bg-background/80 px-8 py-10 text-center shadow-sm backdrop-blur-sm", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3 border-b border-border/50 bg-background/95 px-4 py-3 backdrop-blur-sm", children: [
              ...
              /* @__PURE__ */ jsx(ScrollArea, { className: cn("flex-1 px-4 py-4", crmChatBg), children: composeTarget ? /* @__PURE__ */ jsx("div", { className: "flex min-h-[min(50vh,320px)] flex-col items-center justify-center py-12", children: /* @__PURE__ */ jsxs("div", { className: "max-w-sm rounded-2xl bg-background/85 px-5 py-4 text-center text-sm text-muted-foreground shadow-sm backdrop-blur-sm", children: [
