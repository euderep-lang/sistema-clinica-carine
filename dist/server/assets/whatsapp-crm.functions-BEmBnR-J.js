import { c as createSsrRpc } from "./createSsrRpc-BRag-Yhq.js";
...
export {
  toggleWaConversationTag as A,
  markWaObjection as B,
  processWaFollowUps as C,
  searchWaMessages as D,
  syncWaChatsFromZApi as E,
  createWaDeal as F,
  getCrmAnalytics as G,
  setupPostConsultationFollowUp as H,
  ...
  searchWaMessagesGlobal as j,
  getMetaWaTemplates as k,
  sendWaBroadcast as l,
  moveWaDealStage as m,
  getWaTasks as n,
  createWaTask as o,
  completeWaTask as p,
  getWaTagRules as q,
  deleteWaTagRule as r,
  seedWaQuickReplies as s,
  triggerAppointmentFollowUp as t,
  upsertWaTagRule as u,
  closeWaConversation as v,
  reopenWaConversation as w,
  linkWaPatient as x,
  assignWaConversation as y,
  assignWaQueueToReception as z
};
