...
import { Cake, Users, Megaphone, BarChart3, Send, Check, Download, ExternalLink } from "lucide-react";
import { u as useAuth, D as DashboardShell, S as Select, i as SelectTrigger, j as SelectValue, k as SelectContent, l as SelectItem, B as Button, C as Card, c as CardContent, a as CardHeader, b as CardTitle, A as Avatar, h as AvatarFallback, m as Badge, L as Label, T as Textarea, n as Checkbox, o as Dialog, p as DialogContent, q as DialogHeader, r as DialogTitle, s as DialogFooter, t as randomUUID } from "./router-CL5eFCiw.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-DNoNZC7Z.js";
import { s as supabase } from "./client-CUE-_UGz.js";
import { c as age, d as daysSince, C as CHANNEL_BADGE, a as applyVars, b as buildWhatsAppLink, l as logMessage } from "./messaging-mghX5_br.js";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxs(Button, { onClick: async () => {
        ...
        for (const p of monthPatients) {
          if (!contacted[p.id]) {
            await sendBirthday(p);
    ...
    /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
      ...
      /* @__PURE__ */ jsxs("tbody", { children: [
        rows.slice(0, 50).map((r) => /* @__PURE__ */ jsxs("tr", { className: "border-t", children: [
          ...
          /* @__PURE__ */ jsx("td", { children: r.last_appointment ? new Date(r.last_appointment).toLocaleDateString("pt-BR") : "—" }),
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsx(Dialog, { open: sendOpen, onOpenChange: setSendOpen, children: /* @__PURE__ */ jsxs(DialogContent, { children: [
      ...
      /* @__PURE__ */ jsx(DialogFooter, { children: sendIndex < segmentPatients.length ? /* @__PURE__ */ jsxs(Button, { onClick: sendNext, children: [
        /* @__PURE__ */ jsx(ExternalLink, { className: "size-4 mr-2" }),
        "Abrir próximo"
      ...
      /* @__PURE__ */ jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxs("tbody", { children: [
          history.map((c) => /* @__PURE__ */ jsxs("tr", { className: "border-t", children: [
            /* @__PURE__ */ jsx("td", { className: "p-3", children: new Date(c.date).toLocaleString("pt-BR") }),
      ...
      /* @__PURE__ */ jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxs("tbody", { children: [
          Object.values(tplCounts).map((t) => /* @__PURE__ */ jsxs("tr", { className: "border-t", children: [
            ...
            /* @__PURE__ */ jsx("td", { children: new Date(t.last).toLocaleString("pt-BR") })
          ] }, t.name)),
