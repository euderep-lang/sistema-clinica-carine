import { c as createSsrRpc } from "./createSsrRpc-CFVnU8vV.js";
...
})).handler(createSsrRpc("0cd4afa449a29eabe1f29776d69596bd1feb4d0927417bfdae398c4b84de1aa1"));
...
const getSafeIdSignatureAuthStatus = createServerFn({
  method: "GET"
}).middleware([requireSupabaseAuth]).handler(createSsrRpc("828a3520a35bda80f540dcd768bdb1d1b70d6792f0cd8a58fabbeef723af6252"));
