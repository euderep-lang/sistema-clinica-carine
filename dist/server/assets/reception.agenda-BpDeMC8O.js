...
import { B as Button, w as cn, L as Label, I as Input, S as Select, i as SelectTrigger, j as SelectValue, k as SelectContent, l as SelectItem, n as Checkbox, u as useAuth, o as Dialog, p as DialogContent, q as DialogHeader, r as DialogTitle, m as Badge, x as APPOINTMENT_TYPE_LABEL, s as DialogFooter, y as resolveAppointmentTypes, z as APPOINTMENT_TYPE_OPTIONS, D as DashboardShell, C as Card, a as CardHeader, b as CardTitle, c as CardContent, E as Table, F as TableHeader, G as TableRow, H as TableHead, J as TableBody, M as TableCell, N as APPOINTMENT_STATUS_LABEL, T as Textarea } from "./router-wbAJq94_.js";
import { A as AgendaContactActions } from "./agenda-contact-actions-8xViBGvk.js";
import { s as supabase } from "./client-CUE-_UGz.js";
import { a as addOneHour, f as formatTimeInterval, t as timeToMinutes, b as buildHourSlots, c as currentTimePercent, d as formatAgendaDate, A as AGENDA_DAY_START, e as AGENDA_SLOT_MINUTES, g as AGENDA_DAY_END, h as todayISO } from "./agenda-utils-DsE3sZeK.js";
import { T as Tabs, a as TabsList, b as TabsTrigger } from "./tabs-BmrE13vK.js";
import { p as printWithLetterhead } from "./letterhead-print-xe9aGOhf.js";
...
function AgendaFiltersPanel({
  ...
  const viewDate = /* @__PURE__ */ new Date(`${date}T12:00:00`);
        ...
        /* @__PURE__ */ jsx("div", { className: "min-w-0 flex-1", children: viewMode === "timeline" ? /* @__PURE__ */ jsx(AgendaTimelineView, { date, rows: filteredRows, loading, activeProfessionalId: filterProfessional, onProfessionalChange: setFilterProfessional, professionals, headerExtra: /* @__PURE__ */ jsxs(Badge, { variant: "secondary", className: "bg-primary-foreground/15 text-primary-foreground", children: [
          ...
          /* @__PURE__ */ jsx(CardContent, { className: "p-0 overflow-x-auto", children: /* @__PURE__ */ jsxs(Table, { children: [
            ...
            /* @__PURE__ */ jsx(TableBody, { children: loading ? /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 8, className: "py-10 text-center text-muted-foreground", children: "Carregando agenda..." }) }) : filteredRows.length === 0 ? /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 8, className: "py-10 text-center text-muted-foreground", children: "Nenhum agendamento para os filtros selecionados." }) }) : filteredRows.map((row) => /* @__PURE__ */ jsxs(TableRow, { children: [
              ...
              /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(AgendaContactActions, { phone: row.patients?.phone, patientName: row.patients?.full_name, size: "icon" }) }),
