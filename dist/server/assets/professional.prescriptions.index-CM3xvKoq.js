...
import { u as useAuth, D as DashboardShell, I as Input, S as Select, i as SelectTrigger, j as SelectValue, k as SelectContent, l as SelectItem, B as Button, C as Card, c as CardContent, E as Table, F as TableHeader, G as TableRow, H as TableHead, J as TableBody, M as TableCell, m as Badge } from "./router-uS_mSfDy.js";
...
function PrescriptionsList() {
  ...
  return /* @__PURE__ */ jsx(DashboardShell, { title: "Receituário", children: /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxs(Table, { children: [
      ...
      /* @__PURE__ */ jsx(TableBody, { children: loading ? /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 5, className: "text-center text-muted-foreground py-12", children: "Carregando..." }) }) : rows.length === 0 ? /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 5, className: "text-center text-muted-foreground py-12", children: "Nenhuma receita emitida ainda" }) }) : rows.map((r) => /* @__PURE__ */ jsxs(TableRow, { children: [
