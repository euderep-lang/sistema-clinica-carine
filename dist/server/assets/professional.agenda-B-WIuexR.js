...
import { PlayCircle, Eye, ChevronLeft, ChevronRight, CalendarDays, LayoutGrid, List } from "lucide-react";
import { toast } from "sonner";
import { m as Badge, x as APPOINTMENT_TYPE_LABEL, S as Select, i as SelectTrigger, j as SelectValue, N as APPOINTMENT_STATUS_LABEL, w as cn, a2 as PROFESSIONAL_AGENDA_STATUS_TRIGGER, k as SelectContent, a3 as PROFESSIONAL_AGENDA_STATUS_OPTIONS, l as SelectItem, a4 as PROFESSIONAL_AGENDA_STATUS_ITEM, a5 as PROFESSIONAL_AGENDA_STATUS_VALUES, B as Button, e as Popover, f as PopoverTrigger, g as PopoverContent, u as useAuth, D as DashboardShell, I as Input, C as Card, c as CardContent, E as Table, F as TableHeader, G as TableRow, H as TableHead, J as TableBody, M as TableCell } from "./router-CL5eFCiw.js";
import { P as PageHeader } from "./page-header-BNsdM97h.js";
import { A as AgendaContactActions } from "./agenda-contact-actions-mntzQ5_6.js";
import { b as buildHourSlots, c as currentTimePercent, d as formatAgendaDate, t as timeToMinutes, A as AGENDA_DAY_START, f as formatTimeInterval, e as AGENDA_SLOT_MINUTES, g as AGENDA_DAY_END, w as weekDaysFromMonday, h as todayISO, i as formatWeekRange, s as startOfWeekMonday, j as shiftDate } from "./agenda-utils-DsE3sZeK.js";
import { T as Tabs, a as TabsList, b as TabsTrigger } from "./tabs-DNoNZC7Z.js";
...
function ProfessionalAgendaDayView({
  ...
  const nowPercent = date === (/* @__PURE__ */ new Date()).toISOString().slice(0, 10) ? currentTimePercent() : null;
...
function ProfessionalAgendaPage() {
  ...
  const dateLabel = viewMode === "weekly" ? formatWeekRange(weekStart) : (/* @__PURE__ */ new Date(`${date}T12:00:00`)).toLocaleDateString("pt-BR", {
    weekday: "long",
    day: "2-digit",
    month: "long",
    year: "numeric"
  ...
  return /* @__PURE__ */ jsx(DashboardShell, { title: "Minha Agenda", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsx(PageHeader, { title: "Minha Agenda", description: "Consultas do seu consultório. Atualize a situação e acesse prontuários." }),
    ...
    viewMode === "list" && /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxs(Table, { children: [
      ...
      /* @__PURE__ */ jsx(TableBody, { children: loading ? /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 6, className: "py-10 text-center text-muted-foreground", children: "Carregando…" }) }) : visibleRows.length === 0 ? /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 6, className: "py-10 text-center text-muted-foreground", children: "Nenhuma consulta neste dia." }) }) : visibleRows.map((a) => /* @__PURE__ */ jsxs(TableRow, { children: [
        ...
        /* @__PURE__ */ jsx(TableCell, { className: "text-center", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-center gap-1", children: [
          /* @__PURE__ */ jsx(AgendaContactActions, { phone: a.patients?.phone, patientName: a.patients?.full_name, size: "icon" }),
