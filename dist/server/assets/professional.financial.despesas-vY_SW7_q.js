...
import { u as useAuth, o as Dialog, p as DialogContent, q as DialogHeader, r as DialogTitle, L as Label, I as Input, S as Select, i as SelectTrigger, j as SelectValue, k as SelectContent, l as SelectItem, Y as Switch, T as Textarea, s as DialogFooter, B as Button, Z as parseBRLInput, X as fmt, C as Card, c as CardContent, E as Table, F as TableHeader, G as TableRow, H as TableHead, J as TableBody, M as TableCell, ae as isOverdue, W as fmtDate, aj as PAYMENT_LABEL, m as Badge, af as BILL_STATUS_LABEL, ag as BILL_STATUS_CLASS, aP as DropdownMenu, aQ as DropdownMenuTrigger, aR as DropdownMenuContent, aS as DropdownMenuItem } from "./router-wbAJq94_.js";
import { l as loadExpenseCategories } from "./expense-categories-CwcFN4uW.js";
import { u as updateProfessionalExpense, c as createProfessionalExpense, f as firstDayOfMonth, t as todayISO, l as loadProfessionalExpenses, D as DateRangeFilter, m as markExpensePaid, a as cancelExpense, d as deleteProfessionalExpense } from "./expenses-BvcenOS4.js";
import { l as loadPaymentMethodConfigs, a as activePaymentMethods } from "./payment-methods-BIIPcbLn.js";
...
function ExpenseDialog({ open, onOpenChange, expense, onSaved }) {
  ...
  useEffect(() => {
    ...
    if (expense) {
      ...
      setPaidDate(expense.paid_date ?? (/* @__PURE__ */ new Date()).toISOString().slice(0, 10));
...
function ProfessionalDespesasPage() {
  ...
  const load = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const [data, cats] = await Promise.all([loadProfessionalExpenses(profile.id, {
        status,
        category,
        from,
        to,
  ...
  const filtered = useMemo(() => {
    ...
    if (!q) return rows;
    return rows.filter((r) => r.description.toLowerCase().includes(q) || (r.supplier?.toLowerCase().includes(q) ?? false) || (r.category?.toLowerCase().includes(q) ?? false));
  }, [rows, search]);
  ...
  return /* @__PURE__ */ jsx(FinancialShell, { children: /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-end justify-between gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-end gap-3", children: [
        ...
        /* @__PURE__ */ jsx(Input, { placeholder: "Buscar…", value: search, onChange: (e) => setSearch(e.target.value), className: "w-48" })
      ] }),
        ...
        return /* @__PURE__ */ jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsxs(DropdownMenu, { children: [
            ...
            /* @__PURE__ */ jsxs(DropdownMenuContent, { align: "end", children: [
              ...
              /* @__PURE__ */ jsxs(DropdownMenuItem, { className: "text-destructive focus:text-destructive", onClick: () => void remove(r), children: [
    ...
    /* @__PURE__ */ jsx(ExpenseDialog, { open: dialogOpen, onOpenChange: setDialogOpen, expense: editTarget, onSaved: () => void load() })
  ] }) });
}
export {
  ProfessionalDespesasPage as component
};
