...
import { u as useServerFn } from "./createSsrRpc-tRzdGy4b.js";
import { ArrowLeft, Stethoscope, AlertTriangle, Shield, Copy, Trash2, Plus, FileDown, Send } from "lucide-react";
import { toast } from "sonner";
import { t as randomUUID, o as Dialog, p as DialogContent, q as DialogHeader, r as DialogTitle, B as Button, s as DialogFooter, u as useAuth, b3 as Route, a6 as getTenantSetting, b4 as formatClinicAddressLines, a8 as formatClinicAddress, D as DashboardShell, C as Card, c as CardContent, L as Label, e as Popover, f as PopoverTrigger, g as PopoverContent, _ as Command, $ as CommandInput, a0 as CommandList, a1 as CommandEmpty, a2 as CommandGroup, a3 as CommandItem, I as Input, T as Textarea, S as Select, i as SelectTrigger, j as SelectValue, k as SelectContent, l as SelectItem, b5 as PopoverAnchor, a7 as loadLetterheadForPdf } from "./router-wbAJq94_.js";
import { s as supabase } from "./client-CUE-_UGz.js";
import { T as TYPE_LABEL, F as FORMS, Q as QUANTITY_MODES, D as DOSE_UNITS, R as ROUTES, a as FREQUENCIES, p as parsePrescriptionQuantity, M as MEDICATIONS, f as formatPrescriptionQuantity, g as generatePrescriptionPDF, c as computeSimpleSignatureAnchor, b as SIMPLE_RX_PAGE_H_MM, d as formatRxQuantityLabel, e as formatSignedProfessionalName } from "./prescription-pdf-BEoUnrBo.js";
import { m as maskCPF, g as formatPatientAddress, d as ageFromBirthDate } from "./patient-utils-YNqCHR6o.js";
import { i as initiateSafeIdSignatureAuth, e as getSafeIdSignatureAuthStatus, g as getDigitalCertificateStatus, f as signPrescriptionPdf } from "./digital-certificate.functions-BtCwoc01.js";
import "./server-BMngozWm.js";
...
import "qrcode";
import "zod";
import "./auth-middleware-DK07Zx0-.js";
...
function SafeIdSignatureAuthDialog({
  ...
  return /* @__PURE__ */ jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxs(DialogContent, { children: [
    /* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: renewal ? "Renovar autorização SafeID" : "Autorizar assinatura SafeID" }) }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-3 text-sm text-muted-foreground", children: [
      renewal && /* @__PURE__ */ jsxs("p", { className: "text-amber-800 rounded-md border border-amber-200 bg-amber-50 px-3 py-2", children: [
        "Sua autorização de ",
        /* @__PURE__ */ jsx("strong", { children: "12 horas" }),
      ...
      authError && /* @__PURE__ */ jsx("p", { className: "text-destructive", children: authError }),
      authLoading && /* @__PURE__ */ jsx("p", { className: "text-amber-700", children: "Preparando autorização…" }),
      !authLoading && !authReady && !authError && /* @__PURE__ */ jsx("p", { className: "text-amber-700", children: "Aguardando confirmação no app SafeID…" }),
      authReady && /* @__PURE__ */ jsx("p", { className: "text-emerald-700", children: "Autorização confirmada. Clique em Assinar e finalizar." })
    ] }),
    authorizeUrl && !authReady && !authError && /* @__PURE__ */ jsx(
      Button,
      {
        type: "button",
        variant: "outline",
    ...
    /* @__PURE__ */ jsxs(DialogFooter, { children: [
      /* @__PURE__ */ jsx(Button, { variant: "ghost", onClick: () => onOpenChange(false), disabled: saving, children: "Cancelar" }),
      /* @__PURE__ */ jsx(
        Button,
        {
...
function NewPrescription() {
  ...
  if (loadingDraft) {
    return /* @__PURE__ */ jsx(DashboardShell, { title: draftId ? "Editar rascunho" : "Nova Receita", children: /* @__PURE__ */ jsx("div", { className: "py-20 text-center text-muted-foreground", children: "Carregando rascunho…" }) });
  }
  return /* @__PURE__ */ jsxs(DashboardShell, { title: draftId ? "Editar rascunho" : "Nova Receita", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "fixed bottom-0 left-0 right-0 lg:left-[var(--sidebar-width,16rem)] bg-background/95 backdrop-blur border-t z-30", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center gap-2 px-4 py-3 max-w-screen-2xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
        ...
        canSignWithCert && /* @__PURE__ */ jsxs(Button, { variant: "outline", onClick: onDownloadPdfClick, disabled: saving, children: [
    ...
    /* @__PURE__ */ jsx(SafeIdSignatureAuthDialog, { open: safeIdDialogOpen, onOpenChange: setSafeIdDialogOpen, renewal: safeIdRenewal, saving, onAuthorized: () => void save(true, {
      sign: true
    }) }),
