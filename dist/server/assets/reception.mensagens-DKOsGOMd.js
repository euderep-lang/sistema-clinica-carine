...
import { u as useAuth, D as DashboardShell, C as Card, a as CardHeader, b as CardTitle, c as CardContent, L as Label, e as Popover, f as PopoverTrigger, B as Button, g as PopoverContent, I as Input, A as Avatar, h as AvatarFallback, S as Select, i as SelectTrigger, j as SelectValue, k as SelectContent, l as SelectItem, T as Textarea, m as Badge } from "./router-CL5eFCiw.js";
...
import { a as applyVars, f as formatDateTimeBR, C as CHANNEL_BADGE, S as STATUS_BADGE, b as buildWhatsAppLink, l as logMessage } from "./messaging-mghX5_br.js";
    ...
    /* @__PURE__ */ jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
        ...
        content && /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-emerald-50 dark:bg-emerald-950/30 p-3 border border-emerald-200 dark:border-emerald-800", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "text-[10px] text-emerald-700 dark:text-emerald-300 text-right mt-1", children: (/* @__PURE__ */ new Date()).toLocaleTimeString("pt-BR", {
            hour: "2-digit",
            minute: "2-digit"
          }) })
        ] }),
...
function RemindersTab({
  ...
  async function sendOne(a) {
    ...
    const extras = {
      data_consulta: new Date(a.date).toLocaleDateString("pt-BR"),
    ...
    /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs(CardTitle, { children: [
          ...
          new Date(tomorrow).toLocaleDateString("pt-BR")
        ] }),
