...
import { a as FinancialShell } from "./financial-shell-WlABGBlS.js";
import { P as PageSection } from "./page-section-CTO8Lkaz.js";
import { S as StatCard } from "./stat-card-C65Pc1wT.js";
import { A as AlertDialog, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel, g as AlertDialogAction } from "./alert-dialog-D65cQj_Q.js";
import { Z as parseBRLInput, aH as loadSaleChargeItems, ae as isOverdue, o as Dialog, p as DialogContent, q as DialogHeader, r as DialogTitle, ai as DialogDescription, m as Badge, af as BILL_STATUS_LABEL, ag as BILL_STATUS_CLASS, W as fmtDate, X as fmt, aj as PAYMENT_LABEL, B as Button, aI as billCanReceive, L as Label, I as Input, S as Select, i as SelectTrigger, j as SelectValue, k as SelectContent, l as SelectItem, T as Textarea, aJ as receiveBillPayment, E as Table, F as TableHeader, G as TableRow, H as TableHead, J as TableBody, M as TableCell, u as useAuth, aK as previewInstallments, e as Popover, f as PopoverTrigger, g as PopoverContent, _ as Command, $ as CommandInput, a0 as CommandList, a1 as CommandEmpty, a2 as CommandGroup, a3 as CommandItem, w as cn, s as DialogFooter, aL as updateStandaloneSale, aM as createStandaloneSale, C as Card, c as CardContent, aN as billHasSaleItems, aO as billIsInstallment, aP as DropdownMenu, aQ as DropdownMenuTrigger, aR as DropdownMenuContent, aS as DropdownMenuItem, aT as billIsEditable, aU as billCanReverse, aV as billCanDelete, aW as DropdownMenuSeparator, aX as reverseSale, aY as deleteBill } from "./router-wbAJq94_.js";
import { S as ScrollArea } from "./scroll-area-DqOg5V5b.js";
import { a as activePaymentMethods, c as calculatePaymentFee, l as loadPaymentMethodConfigs } from "./payment-methods-BIIPcbLn.js";
import { s as supabase } from "./client-CUE-_UGz.js";
import { m as maskCPF } from "./patient-utils-YNqCHR6o.js";
import { p as periodFromYearMonth, c as currentYearMonth } from "./commission-Dy1bnNjc.js";
import { c as computeCompetencePeriodStats } from "./financial-competence-DMShlSI3.js";
            ...
            "li",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("span", { children: [
                  ...
                  " ·",
                  " ",
                  (/* @__PURE__ */ new Date(p.dueDate + "T12:00:00")).toLocaleDateString("pt-BR")
                ] }),
...
function ProfessionalFinancialIndexPage() {
  const {
    profile
  } = useAuth();
  const [rows, setRows] = useState([]);
  ...
  const load = useCallback(async () => {
    ...
    let q = supabase.from("bills_receivable").select("id, description, amount, paid_amount, due_date, paid_date, competence_date, payment_method, status, notes, budget_id, patient_id, installment_number, installment_count, consultation_charge_id, patients(full_name)").or(`professional_id.eq.${profile.id},professional_id.is.null`).order("due_date", {
      ascending: false
    }).limit(200);
  ...
  const detailBill = useMemo(() => rows.find((r) => r.id === detailBillId) ?? null, [rows, detailBillId]);
  const confirmReverse = async () => {
    if (!reverseTarget) return;
    setActionLoading(true);
    try {
      await reverseSale(reverseTarget.id, "Estorno pelo profissional");
      toast.success(billHasSaleItems(reverseTarget) ? "Venda estornada — estoque devolvido" : "Cobrança cancelada");
      setReverseTarget(null);
      await load();
    } catch (e) {
      toast.error(e.message);
  ...
  return /* @__PURE__ */ jsx(FinancialShell, { children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
...
export {
  ProfessionalFinancialIndexPage as component
};
