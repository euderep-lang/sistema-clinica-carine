...
import { C as Card, c as CardContent, L as Label, S as Select, i as SelectTrigger, j as SelectValue, k as SelectContent, l as SelectItem, u as useAuth, a as CardHeader, b as CardTitle, W as fmtDate, E as Table, J as TableBody, G as TableRow, M as TableCell, X as fmt, F as TableHeader, H as TableHead, ae as isOverdue, m as Badge, af as BILL_STATUS_LABEL, ag as BILL_STATUS_CLASS, aj as PAYMENT_LABEL } from "./router-wbAJq94_.js";
import { T as TableSkeleton } from "./feedback-states-D6nt86QM.js";
import { f as firstDayOfMonth, t as todayISO, D as DateRangeFilter, l as loadProfessionalExpenses } from "./expenses-BvcenOS4.js";
...
function ProducaoReport({ from, to }) {
  ...
  return /* @__PURE__ */ jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxs(BarChart, { data: chart, children: [
      /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3" }),
      /* @__PURE__ */ jsx(XAxis, { dataKey: "name" }),
      /* @__PURE__ */ jsx(YAxis, { tickFormatter: (v) => fmt(v) }),
      /* @__PURE__ */ jsx(Tooltip, { formatter: (v) => fmt(v) }),
...
function DespesasReport({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsx(CardContent, { children: byCategory.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "Sem despesas no período." }) : /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxs(BarChart, { data: byCategory, layout: "vertical", children: [
        /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3" }),
        /* @__PURE__ */ jsx(XAxis, { type: "number", tickFormatter: (v) => fmt(v) }),
...
function ProfessionalRelatoriosPage() {
  return /* @__PURE__ */ jsx(FinancialShell, { children: /* @__PURE__ */ jsx(ProfessionalFinancialReports, {}) });
}
export {
  ProfessionalRelatoriosPage as component
};
