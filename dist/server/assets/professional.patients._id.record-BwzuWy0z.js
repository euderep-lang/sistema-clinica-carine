...
import { f as formatFileSizeKb, R as ResizablePanelGroup, a as ResizablePanel, b as ResizableHandle, c as compressForUpload } from "./resizable-DYucfpuq.js";
import { ArrowLeftRight, Loader2, ImageOff, ChevronDown, X, Search, Flag, CalendarCheck, FilePenLine, Camera, Salad, LayoutGrid, FlaskConical, Columns2, Paperclip, FileText, Image, DollarSign, CheckCircle2 } from "lucide-react";
import { s as Dialog, t as DialogContent, w as DialogHeader, x as DialogTitle, ae as DialogDescription, L as Label, S as Select, l as SelectTrigger, m as SelectValue, n as SelectContent, o as SelectItem, B as Button, E as cn, q as Badge, I as Input, T as Textarea, y as DialogFooter, u as useAuth, aG as TooltipProvider, aH as Tooltip, aI as TooltipTrigger, aJ as TooltipContent, aV as Separator, aN as Sheet, aO as SheetContent, aP as SheetHeader, aQ as SheetTitle, aW as SheetDescription, C as Card, f as CardContent, aX as Route, D as DashboardShell, z as randomUUID } from "./router-D_mhnWOa.js";
import { P as PatientSessionsDialog } from "./patient-sessions-dialog-BNKtSGEP.js";
import { S as ScrollArea } from "./scroll-area-CZMombI1.js";
import * as CollapsiblePrimitive from "@radix-ui/react-collapsible";
import { useNavigate } from "@tanstack/react-router";
import { S as SessionCheckoffDialog } from "./session-history-dialog-UeGvH_Ms.js";
import { u as useServerFn } from "./createSsrRpc-CzfufYmk.js";
import { J as setupPostConsultationFollowUp } from "./whatsapp-crm.functions-7xmbQXVs.js";
