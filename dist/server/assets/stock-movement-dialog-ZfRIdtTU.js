...
import { u as useAuth, o as Dialog, p as DialogContent, q as DialogHeader, r as DialogTitle, L as Label, S as Select, i as SelectTrigger, j as SelectValue, k as SelectContent, l as SelectItem, w as cn, I as Input, T as Textarea, s as DialogFooter, B as Button } from "./router-CL5eFCiw.js";
import { s as supabase } from "./client-CUE-_UGz.js";
import { toast } from "sonner";
const UNITS = ["un", "cx", "rl", "L", "mL", "kg", "g", "tb", "fr", "amp", "cps"];
...
function StockMovementDialog({
  ...
  const [selItem, setSelItem] = useState(itemId ?? "");
  const [type, setType] = useState(fixedType ?? "in");
  const [quantity, setQuantity] = useState("");
  const [date, setDate] = useState((/* @__PURE__ */ new Date()).toISOString().slice(0, 16));
  const [reason, setReason] = useState(fixedReason ?? "");
  ...
  useEffect(() => {
    ...
    setPatient("");
    setNotes("");
    setDate((/* @__PURE__ */ new Date()).toISOString().slice(0, 16));
    (async () => {
  ...
  return /* @__PURE__ */ jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-lg", children: [
    /* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: title ?? "Movimentação de Estoque" }) }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Label, { children: "Item" }),
        /* @__PURE__ */ jsxs(Select, { value: selItem, onValueChange: setSelItem, disabled: !!itemId, children: [
          /* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Selecione um item" }) }),
          /* @__PURE__ */ jsx(SelectContent, { children: items.map((i) => /* @__PURE__ */ jsx(SelectItem, { value: i.id, children: i.name }, i.id)) })
        ] }),
        current && /* @__PURE__ */ jsxs("p", { className: "text-xs text-muted-foreground mt-1", children: [
          "Estoque atual: ",
      ...
      !fixedType && /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Label, { children: "Tipo" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-1 mt-1", children: Object.keys(MOVEMENT_LABEL).map((t) => /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
            "data-active": type === t,
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(Label, { children: type === "adjustment" ? "Novo estoque total" : "Quantidade" }),
          /* @__PURE__ */ jsx(Input, { type: "number", min: "0", step: "0.01", value: quantity, onChange: (e) => setQuantity(e.target.value) })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(Label, { children: "Data" }),
          /* @__PURE__ */ jsx(Input, { type: "datetime-local", value: date, onChange: (e) => setDate(e.target.value) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Label, { children: "Motivo" }),
        /* @__PURE__ */ jsxs(Select, { value: reason, onValueChange: setReason, disabled: !!fixedReason, children: [
          /* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Selecione" }) }),
          /* @__PURE__ */ jsx(SelectContent, { children: reasonOptions.map((r) => /* @__PURE__ */ jsx(SelectItem, { value: r, children: r }, r)) })
        ] })
      ] }),
      type === "in" && /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Label, { children: "Preço unitário (R$)" }),
        /* @__PURE__ */ jsx(Input, { type: "number", min: "0", step: "0.01", value: unitCost, onChange: (e) => setUnitCost(e.target.value) })
      ] }),
      !hidePatient && /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Label, { children: "Paciente (opcional)" }),
        /* @__PURE__ */ jsxs(Select, { value: patient || "none", onValueChange: (v) => setPatient(v === "none" ? "" : v), children: [
          /* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, {}) }),
          /* @__PURE__ */ jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsx(SelectItem, { value: "none", children: "— Nenhum —" }),
            patients.map((p) => /* @__PURE__ */ jsx(SelectItem, { value: p.id, children: p.full_name }, p.id))
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
      ...
      current && qNum > 0 && /* @__PURE__ */ jsxs("p", { className: "text-sm bg-muted px-3 py-2 rounded-md", children: [
        "Após este registro: estoque passará de ",
        /* @__PURE__ */ jsx("strong", { children: Number(current.current_stock) }),
        " para ",
        /* @__PURE__ */ jsx("strong", { children: after }),
        " ",
        current.unit,
        "."
      ] })
