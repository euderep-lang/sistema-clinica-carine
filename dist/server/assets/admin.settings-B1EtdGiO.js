...
import { u as useAuth, am as DEFAULT_HOURS, a6 as getTenantSetting, C as Card, a as CardHeader, b as CardTitle, c as CardContent, L as Label, I as Input, an as maskCNPJ, ao as maskPhone, ap as maskCEP, aq as DAY_LABELS, Y as Switch, B as Button, ar as fetchViaCEP, as as setTenantSetting, at as FONT_OPTIONS, au as loadGoogleFont, m as Badge, av as applyThemeColors, aw as applyFont, o as Dialog, p as DialogContent, q as DialogHeader, r as DialogTitle, T as Textarea, s as DialogFooter, ax as resolveSpecialties, ay as isLegacySpecialtyList, E as Table, F as TableHeader, G as TableRow, H as TableHead, J as TableBody, M as TableCell, A as Avatar, h as AvatarFallback, ai as DialogDescription, S as Select, i as SelectTrigger, j as SelectValue, k as SelectContent, l as SelectItem, O as DEFAULT_APPOINTMENT_TYPES, v as renderTemplate, az as TEMPLATE_VARS, aA as SAMPLE_VARS, aB as TooltipProvider, aC as Tooltip, aD as TooltipTrigger, aE as TooltipContent, Q as CardDescription, aF as PAYMENT_METHODS, D as DashboardShell, w as cn } from "./router-wbAJq94_.js";
...
import { c as createSsrRpc, u as useServerFn } from "./createSsrRpc-tRzdGy4b.js";
...
import { S as SectionServicos } from "./section-servicos-C4UPiWuE.js";
import { l as loadPaymentMethodConfigs, e as ensurePaymentMethodConfigs, s as savePaymentMethodConfig } from "./payment-methods-BIIPcbLn.js";
import { l as loadExpenseCategories, e as ensureExpenseCategories, c as createExpenseCategory, s as saveExpenseCategory } from "./expense-categories-CwcFN4uW.js";
...
function SectionUsuarios() {
  ...
  const load = async () => {
    const { data } = await supabase.from("profiles").select("id,full_name,role,specialty,crm,cpf,phone,active,commission_pct").order("full_name");
    setRows(data ?? []);
  };
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Table, { children: [
      ...
      /* @__PURE__ */ jsx(TableBody, { children: rows.map((r) => /* @__PURE__ */ jsxs(TableRow, { children: [
        ...
        /* @__PURE__ */ jsx(TableCell, { className: "font-medium", children: r.full_name }),
    ...
    /* @__PURE__ */ jsx(Dialog, { open, onOpenChange: setOpen, children: /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-lg", children: [
      ...
      tempPwd ? /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
        ...
        !editing ? /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx(Label, { children: "Redefinir senha" }),
          /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsx(Button, { type: "button", variant: "secondary", size: "sm", onClick: applyPasswordReset, disabled: busy, children: "Aplicar nova senha" })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
  ...
  return /* @__PURE__ */ jsx(TooltipProvider, { children: /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-4", children: INTEGRATIONS.map((i) => /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "p-4 space-y-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
        ...
        /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "bg-amber-50 text-amber-700 border-amber-200 mt-0.5", children: "Em breve" })
      ] })
    ] }),
