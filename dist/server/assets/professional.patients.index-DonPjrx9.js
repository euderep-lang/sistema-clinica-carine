...
import { u as useAuth, D as DashboardShell, C as Card, I as Input, B as Button, E as Table, F as TableHeader, G as TableRow, H as TableHead, J as TableBody, M as TableCell } from "./router-uS_mSfDy.js";
...
function ProfessionalPatients() {
  ...
  const load = async () => {
    ...
    const ids = Array.from(new Set((ap ?? []).map((a) => a.patient_id).filter(Boolean)));
    if (ids.length === 0) {
      setRows([]);
      setTotal(0);
      setLoading(false);
  ...
  return /* @__PURE__ */ jsx(DashboardShell, { title: "Meus Pacientes", children: /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsx(PageHeader, { title: "Meus Pacientes", description: "Busque pacientes e acesse ficha, prontuário, sessões e agenda." }),
    /* @__PURE__ */ jsxs(Card, { className: "overflow-hidden", children: [
      ...
      empty ? /* @__PURE__ */ jsxs("div", { className: "px-4 py-16 text-center", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Pacientes aparecem aqui após agendamentos no seu consultório." })
