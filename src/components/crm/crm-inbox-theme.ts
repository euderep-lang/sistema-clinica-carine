...
/** Lista 320px · chat limitado · painel 340px (laterais originais) */
export const crmPanelShell =
  "flex min-h-0 min-w-0 flex-1 overflow-hidden rounded-2xl border border-border/60 bg-card shadow-[0_1px_3px_rgba(0,0,0,0.06)] lg:grid lg:grid-cols-[320px_minmax(280px,min(440px,1fr))_340px]";
