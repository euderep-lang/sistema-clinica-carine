...
function CrmLoginPage() {
  ...
  return (
    <div
      className="crm-mobile-shell app-safe-area-top app-safe-area-x app-safe-area-bottom fixed inset-0 z-50 flex flex-col overflow-hidden bg-[#111b21] text-white"
      style={{
        width: "100%",
