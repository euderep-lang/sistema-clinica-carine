...
export const Route = createFileRoute("/_authenticated/professional/financial/")({
  component: ProfessionalFinancialIndexPage,
});
...
function ProfessionalFinancialIndexPage() {
  ...
  const confirmReverse = async () => {
    ...
    try {
      ...
      toast.success(
        billHasSaleItems(reverseTarget)
          ? "Venda estornada — estoque devolvido"
          : "Cobrança cancelada",
      );
            ...
            <TableBody>
              {loading ? (
                ...
                filtered.map((r) => {
                  ...
                  const hasSale = billHasSaleItems(r);
                  return (
                    <TableRow
                      key={r.id}
                      ...
                      <TableCell>
                        ...
                        {billIsInstallment(r) && (
                          <Badge variant="outline" className="mt-1 text-[10px]">
                            Parcela {r.installment_number}/{r.installment_count}
                          </Badge>
                        )}
                      </TableCell>
                      ...
                      <TableCell onClick={(e) => e.stopPropagation()}>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            {billIsEditable(r) && (
                              <DropdownMenuItem onClick={() => { setEditBillId(r.id); setSaleOpen(true); }}>
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              onClick={(e) => { e.preventDefault(); void confirmReverse(); }}
            >
              Confirmar estorno
            </AlertDialogAction>
          </AlertDialogFooter>
